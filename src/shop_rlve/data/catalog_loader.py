"""Catalog and persona loading for ShopRLVE-GYM.
...
from shop_rlve.data.schema import ATTRIBUTE_ALLOWLIST, Product, Variant
...
def load_catalog(
    ...
    logger.info(
        "Loading catalog from HuggingFace: %s (split=%s, max_items=%s)",
        dataset_name,
        split,
        max_items,
    )
