"""Abstract base environment and registry for ShopRLVE-GYM.
...
from shop_rlve.data.schema import ATTRIBUTE_ALLOWLIST, Product
from shop_rlve.difficulty.mapping import DifficultyParams, map_difficulty
from shop_rlve.rewards.metrics import constraint_satisfaction
