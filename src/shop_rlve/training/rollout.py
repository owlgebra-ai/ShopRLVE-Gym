"""Multi-turn episode rollout for ShopRLVE-GYM RL training (Spec Section 9).
...
Usage:
    ...
    from shop_rlve.training.rollout import run_rollout, DummyModelFn
...
from shop_rlve.server.state import Observation
...
def run_batch_rollouts(
    ...
    When parallel=True, note that ShopRLVEEnv is NOT thread-safe.
    ...
    Args:
        env:             ShopRLVEEnv instance (used as template for parallel).
