"""Episode state management for ShopRLVE-GYM (Spec Section 8.1).
...
from shop_rlve.data.schema import Product, Variant
from shop_rlve.rewards.composer import RewardBreakdown
from shop_rlve.simulator.persona import PersonaWeights
from shop_rlve.tools.cart import CartState
from shop_rlve.tools.catalog import CatalogState
from shop_rlve.tools.orders import Order
from shop_rlve.tools.policy import PolicyKB
from shop_rlve.tools.registry import ToolCall
...
class EpisodeState:
    ...
    by :class:`~shop_rlve.server.openenv.ShopRLVEEnv`.
