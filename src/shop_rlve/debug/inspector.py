"""Episode inspector for debugging ShopRLVE-GYM episodes.
...
class EpisodeInspector:
    """Debug inspector for episode traces produced by ShopRLVEEnv.
    ...
    Args:
        env: Optional ShopRLVEEnv instance (used for live inspection).
    """
    ...
    def __init__(self, env: Any | None = None) -> None:
        ...
        Args:
            env: Optional ShopRLVEEnv instance. When provided, the inspector
