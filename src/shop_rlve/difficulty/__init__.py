"""Difficulty engine for ShopRLVE-GYM.
...
from shop_rlve.difficulty.adaptive import AdaptiveDifficultyEngine, AdaptiveState
from shop_rlve.difficulty.mapping import (
    B_branch,
    B_tool,
    DifficultyParams,
    H_orders,
