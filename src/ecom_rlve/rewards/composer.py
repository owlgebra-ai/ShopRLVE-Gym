"""Reward composition for EcomRLVE-GYM (Spec Section 5).
...
from ecom_rlve.rewards.metrics import efficiency_reward, hallucination_reward
...
def compose_reward(
    ...
    *,
    ...
    user_clarification_turns: int = 0,
    debug: bool = False,
) -> RewardBreakdown:
    ...
    r_eff_val = efficiency_reward(turns, t_max, user_clarification_turns)
    ...
    if debug:
        ...
        details["turns"] = turns
        details["t_max"] = t_max
        details["user_clarification_turns"] = user_clarification_turns
        details["effective_turns"] = max(1, turns - user_clarification_turns)
