"""Episode replay and environment probing for EcomRLVE-GYM debugging.
...
Usage:
    from ecom_rlve.debug.replay import replay_episode, probe_env
...
from ecom_rlve.envs.base import EpisodeResult
...
def replay_episode(
    ...
    Args:
        env:          EcomRLVEEnv instance (should have the same catalog).
