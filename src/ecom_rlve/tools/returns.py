"""Returns and exchange engine for EcomRLVE-GYM.
...
from ecom_rlve.tools.orders import Order, OrderLine
...
def return_initiate(
    ...
    *,
    ...
    if method == "mail":
        label_url = f"https://returns.ecomrlve.example/labels/{return_id}"
