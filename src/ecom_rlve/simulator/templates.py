"""User utterance templates for each EcomRLVE-GYM environment.
...
_TEMPLATES: dict[str, list[str]] = {
    ...
    # -----------------------------------------------------------------------
    "RETURN": [
        "I want to return the {product_desc}. {?reason?} {?replacement_req?}",
        "I need to return an item from a recent order. It's the {product_desc}. {?reason?}",
        "Can I return the {product_desc}? {?reason?} {?replacement_req?}",
        "I'd like to initiate a return for the {product_desc}. {?reason?}",
        "Please help me return the {product_desc} I received recently. {?reason?} {?replacement_req?}",
        "The {product_desc} I ordered needs to be returned. {?reason?}",
        "I'm not satisfied with the {product_desc}. How do I return it? {?reason?} {?replacement_req?}",
        "Return request for the {product_desc}. {?reason?}",
    ],
    # -----------------------------------------------------------------------
...
_CLARIFICATION_TEMPLATES: dict[str, list[str]] = {
    ...
    "order_ref": [
        "The order ID is {order_ref}.",
        "It's from order {order_ref}.",
